defmodule ServerTestNative do
  ...
  import ServerTestWeb, only: [verified_routes: 0]
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([ServerTestWeb, CoreComponents, plugin.module_suffix])
