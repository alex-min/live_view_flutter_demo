defmodule ServerTestWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `ServerTestWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ServerTestWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ServerTestWeb.Gettext, "errors", msg, opts)
    end
  end
